<?php
/**
 * @version 1.5.3 $Id: admin.rsheader.php
	...
	<div id="submenu-box">
		...
		<div class="m">
			<ul id="submenu">
				...
				<li><a href="http://www.rswebsols.com/rsmonials-support" target="_blank" <?php if($_REQUEST['task'] == 'doc') { ?>class="active"<?php } ?>>Help / Readme / Documentation</a></li>
			</ul>
			<div class="clr"></div>
		</div>
