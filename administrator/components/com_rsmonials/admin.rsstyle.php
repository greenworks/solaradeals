<?php
/**
 * @version 1.5.3 $Id: admin.rssettings.php
...
<div>
<div>&nbsp;</div>
<table width="100%" cellpadding="0" cellspacing="0"><tr><td><h1>Copy this CSS Code and paste in the CSS file of your website Template.</h1></td><td align="right"></td></tr></table>
<div>&nbsp;</div>
</div>
<div id="editcell">
	...
	<thead>
		...
		<tbody>
			<tr class="row0">
				...
				fclose($fp);
				?>				</td>
				<td align="center" valign="top"><a href="index.php?option=<?php echo $_REQUEST['option']; ?>&task=<?php echo $_REQUEST['task']; ?>&action=edit" title="Edit Item"><img src="images/edit_f2.png" border="0" alt="Edit" /></a></td>
				<td align="center" valign="top"><a href="index.php?option=<?php echo $_REQUEST['option']; ?>&task=<?php echo $_REQUEST['task']; ?>&action=restore" title="Restore Default" onclick="javascript:if(confirm('Restore default value! Are you sure? This will remove all your css customization.')){return true;}else{return false;}"><img src="images/restore_f2.png" border="0" alt="Restore" /></a></td>
			</tr>
		</tbody>
  </table>
</div>
...
<div>
<div>&nbsp;</div>
<div><h1><?php echo ucfirst(strtolower($_REQUEST['action'])); ?> and Copy this CSS Code and paste in the CSS file of your website Template.</h1></div>
<div>&nbsp;</div>
</div>
