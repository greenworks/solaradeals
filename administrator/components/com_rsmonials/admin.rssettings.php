...
<div>
<div>&nbsp;</div>
<table width="100%" cellpadding="0" cellspacing="0"><tr><td><h1>Manage Settings</h1></td><td align="right"><a href="index.php?option=<?php echo $_REQUEST['option']; ?>&task=<?php echo $_REQUEST['task']; ?>&action=editall&page=<?php echo $_REQUEST['page']; ?>&limit=<?php echo $_REQUEST['limit']; ?>" title="Edit All Item"><img src="images/edit_f2.png" border="0" alt="Edit All" /></a></td></tr></table>
<div>&nbsp;</div>
</div>
<div id="editcell">
