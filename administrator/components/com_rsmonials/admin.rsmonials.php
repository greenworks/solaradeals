<?php
/**
 * @version 1.5.3 $Id: admin.rsmonials.php
...
<div id="element-box">
	...
	<div id="cpanel">
		...
		<div style="float:left;"><div class="icon"><a href="http://www.rswebsols.com/rsmonials-support" style="height:auto;" target="_blank"><img src="components/com_rsmonials/images/doc.gif" alt="Documentation" /><span style="font-weight:bold; font-size:16px;">Help /<br />Readme<br /></span></a></div></div>
