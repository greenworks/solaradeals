		...
		<tbody>
			...
			?>
						<tr class="row<?php echo $cntr; ?>">
							...
							<td align="center" valign="top"><a href="index.php?option=<?php echo $_REQUEST['option']; ?>&task=<?php echo $_REQUEST['task']; ?>&action=edit&filepath=<?php echo $langdisplaypath; ?>" title="Edit Item"><img src="images/edit_f2.png" border="0" alt="Edit" /></a></td>
							<td align="center" valign="top"><a href="index.php?option=<?php echo $_REQUEST['option']; ?>&task=<?php echo $_REQUEST['task']; ?>&action=restore&filepath=<?php echo $langdisplaypath; ?>" title="Restore Default" onclick="javascript:if(confirm('Restore default value! Are you sure? This will remove all your css customization.')){return true;}else{return false;}"><img src="images/restore_f2.png" border="0" alt="Restore" /></a></td>
						</tr>
			<?php
						$cntr++;
					}
