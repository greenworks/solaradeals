...
function getUpIcon()
{
		return "<img src='/administrator/images/uparrow.png' />";
}
function getDownIcon()
{
		return "<img src='/administrator/images/downarrow.png' />";
}
...
<table>
	<tr>
		<td>
			...
			<input type="button" value="<?php echo JText::_('DEAL_RESET');?>" onClick="location.href='index.php?option=com_enmasse&controller=deal&filter[name]=&filter[location_id]=&filter[category_id]=&filter[published]=&filter[status]='" />
		</td>
	</tr>
</table>
