...
?>
        {
            ...
            if (form.name.value == "")
            {
                alert( "<?php echo JText::_( 'FILL_IN_DEAL_NAME', true ); ?>" );
            }
...
<table class="admintable">
	<tr>
		...
		* </label></td>
		<td><input class="required" type="text" name="name" id="name"
			size="45" maxlength="250" value="<?php echo $row->name;?>" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><textarea class="text_area" name="short_desc" id="short_desc"
			rows="3" cols="50"><?php echo $row->short_desc;?></textarea></td>
	</tr>
	<tr>
		...
		* </label></td>
		<td><?php echo $this->currencyPrefix;?> <input class="text_area"
			type="text" name="origin_price" id="origin_price" size="20"
	...
	<tr>
		...
		* </label></td>
		<td><?php echo $this->currencyPrefix;?> <input class="text_area"
			type="text" name="price" id="price" size="20" maxlength="250"
		...
		* </label></td>
		<td>
            <?php
                ...
                $joomla = $version->getShortVersion();
                if(substr($joomla,0,3) == '1.6'){
            	    echo JHTML::_('calendar',$row->start_at, 'start_at','start_at','%Y-%m-%d' , array('size'=>30));
                }else{
            ?>
		...
		* </label></td>
		<td>
            <?php
                ...
                $joomla = $version->getShortVersion();
                if(substr($joomla,0,3) == '1.6'){
            	    echo JHTML::_('calendar',$row->end_at, 'end_at','end_at','%Y-%m-%d' , array('size'=>30));
                }else{
            ?>
                    <input type="text" name="end_at" id="end_at"
            			value="<?php echo $row->end_at ?>" size="30"> <input type="reset"
            			class="button" value="..."
...
<input type="hidden" name="position"
	...
	value="deal" /> <input type="hidden" name="task" value="" /></form>
