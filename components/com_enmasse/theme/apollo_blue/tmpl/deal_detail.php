    ...
    <div class="leftcontent">
      <div class="buybox">
        <div class="middle">
          ...
          <a class="buybutton" href="<?php echo JRoute::_( 'index.php?controller=shopping&task=addToCart&dealId='. $deal->id ); ?>">
         </a> 
         </div>
      </div>
      <div class="column">
...
<?php 
	...
	{
		 echo '<div class="text">';
	     echo JTEXT::_('DEAL_IS_UPCOMMING');
	     echo '</div>';
	} 
	else if($deal->status == 'Voided')
	{
		  echo '<div class="text">';
	      echo JTEXT::_('DEAL_IS_CANCEL');
	      echo '</div>';
	}
	else
	{
