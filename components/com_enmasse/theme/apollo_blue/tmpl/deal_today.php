...
<link href="components/com_enmasse/theme/apollo_blue/css/style.css" rel="stylesheet" type="text/css" />
<link href="components/com_enmasse/theme/apollo_blue/css/blinds.css" rel="stylesheet" type="text/css" />
<link href="components/com_enmasse/theme/apollo_blue/css/basic.css" rel="stylesheet" type="text/css" />
<link href="components/com_enmasse/theme/apollo_blue/css/basic_ie.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="components/com_enmasse/theme/apollo_blue/script/DD_roundies_0.0.2a-min.js" ></script>
<script type="text/javascript" >DD_roundies.addRule ('.descrip', '2px', true );</script>
<script language="Javascript" type="text/javascript" src="components/com_enmasse/theme/apollo_blue/script/jquery-1.4.1.js"></script>
<script language="Javascript" type="text/javascript" src="components/com_enmasse/theme/apollo_blue/script/jquery.blinds-0.9.js"></script>
<script language="Javascript" type="text/javascript" src="components/com_enmasse/theme/apollo_blue/script/jquery.simplemodal.js"></script>
  ...
  <div class="content">
    <div class="leftcontent">
      ...
      <div class="column">
        ...
        <div class="h5"></div>
        <a class="giftbox" href="index.php?option=com_enmasse&controller=shopping&task=addToCart&dealId=<?php echo $deal->id;?>"><img src="components/com_enmasse/theme/apollo_blue/images/giftbox.png" alt="" /></a>
        <div class="h6"></div>
        <div class="timebox">
          ...
          <div class="text" id="csec"><b>00</b></div>
            <img src="components/com_enmasse/theme/apollo_blue/images/imgs/avatar4.png" alt="" />
        </div>
        <div class="h6"></div>
        <div class="rankbox">
