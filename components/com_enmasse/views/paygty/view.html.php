...
class EnmasseViewPayGty extends JView
{
	function display($tpl = null)
	{
		...
		$this->assignRef( 'user', JModel::getInstance('user','enmasseModel')->getUser() );
		$this->assignRef( 'systemName', JModel::getInstance('setting','enmasseModel')->getCompanyName() );
		$this->assignRef( 'attributeConfig', json_decode($payGty->attribute_config));
		$this->assignRef( 'orderDisplayId', EnmasseHelper::displayOrderDisplayId($orderId));
