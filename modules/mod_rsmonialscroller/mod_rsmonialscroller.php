<?php
/**
 * @version 1.5.3.2 $Id: mod_rsmonialscroller.php
 * @package Joomla 1.5.x
 * @subpackage RS-MonialScroller Modules only for RS-Monials Component
...
for($im=0; $im<count($testi_RSMSC); $im++) {
	...
	$siteLang_RSMSC = $dateConfig_RSMSC->getValue('config.language');
	...
	$RStesti_pic_file = '';
	if($imgDispRSMSC == '1') {
		if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_rsmonials'.DS.'images'.DS.$testi_RSMSC[$im]['id'].'.gif')) {
			$RStesti_pic_file = '<img src="'.JURI::root().'components/com_rsmonials/images/'.$testi_RSMSC[$im]['id'].'.gif" style="max-width:'.$imgMwRSMSC.'px; max-height:'.$imgMhRSMSC.'px; border:'.$imgBorderRSMSC.';" />';
		} else if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_rsmonials'.DS.'images'.DS.$testi_RSMSC[$im]['id'].'.png')) {
			$RStesti_pic_file = '<img src="'.JURI::root().'components/com_rsmonials/images/'.$testi_RSMSC[$im]['id'].'.png" style="max-width:'.$imgMwRSMSC.'px; max-height:'.$imgMhRSMSC.'px; border:'.$imgBorderRSMSC.';" />';
		} else if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_rsmonials'.DS.'images'.DS.$testi_RSMSC[$im]['id'].'.jpg')) {
			$RStesti_pic_file = '<img src="'.JURI::root().'components/com_rsmonials/images/'.$testi_RSMSC[$im]['id'].'.jpg" style="max-width:'.$imgMwRSMSC.'px; max-height:'.$imgMhRSMSC.'px; border:'.$imgBorderRSMSC.';" />';
		} else if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_rsmonials'.DS.'images'.DS.$testi_RSMSC[$im]['id'].'.jpeg')) {
			$RStesti_pic_file = '<img src="'.JURI::root().'components/com_rsmonials/images/'.$testi_RSMSC[$im]['id'].'.jpeg" style="max-width:'.$imgMwRSMSC.'px; max-height:'.$imgMhRSMSC.'px; border:'.$imgBorderRSMSC.';" />';
		} else {
...
<?php
	...
	echo '<a href="'.base64_decode('aHR0cDovL3d3dy5yc3dlYnNvbHMuY29t').'"></a>';
?>
<?php
}
else {
