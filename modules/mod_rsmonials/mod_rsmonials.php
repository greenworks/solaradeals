<?php
/**
 * @version 1.5.3.1 $Id: mod_rsmonials.php
...
if($cId->id > 0) {
	...
	if($displayRSMonials['id'] > 0) {
		...
		$RStesti_pic_file = '';
		if($imgDispRSM == '1') {
			if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_rsmonials'.DS.'images'.DS.$displayRSMonials['id'].'.gif')) {
				$RStesti_pic_file = '<img src="'.JURI::root().'components/com_rsmonials/images/'.$displayRSMonials['id'].'.gif" style="max-width:'.$imgMwRSM.'px; max-height:'.$imgMhRSM.'px; border:'.$imgBorderRSM.';" />';
			} else if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_rsmonials'.DS.'images'.DS.$displayRSMonials['id'].'.png')) {
				$RStesti_pic_file = '<img src="'.JURI::root().'components/com_rsmonials/images/'.$displayRSMonials['id'].'.png" style="max-width:'.$imgMwRSM.'px; max-height:'.$imgMhRSM.'px; border:'.$imgBorderRSM.';" />';
			} else if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_rsmonials'.DS.'images'.DS.$displayRSMonials['id'].'.jpg')) {
				$RStesti_pic_file = '<img src="'.JURI::root().'components/com_rsmonials/images/'.$displayRSMonials['id'].'.jpg" style="max-width:'.$imgMwRSM.'px; max-height:'.$imgMhRSM.'px; border:'.$imgBorderRSM.';" />';
			} else if(file_exists(JPATH_ROOT.DS.'components'.DS.'com_rsmonials'.DS.'images'.DS.$displayRSMonials['id'].'.jpeg')) {
				$RStesti_pic_file = '<img src="'.JURI::root().'components/com_rsmonials/images/'.$displayRSMonials['id'].'.jpeg" style="max-width:'.$imgMwRSM.'px; max-height:'.$imgMhRSM.'px; border:'.$imgBorderRSM.';" />';
			} else {
