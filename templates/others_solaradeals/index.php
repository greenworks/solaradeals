...
<div class="art-logo">
 <h1 class="art-logo-name"><a href="<?php echo $document->baseurl; ?>/"><image src="http://hlab.haatopia.com/customer/solaradeals/images/logo_new_03.png" style="width:134px; height:50px; border:0";></a></h1>
</div>
<div class="search">
LogIn | Register
</div>
        ...
        <div class="art-footer-center">
            <div class="art-footer-wrapper">
                <div class="art-footer-text">
                    ...
                    <?php else: ?>
                    <?php ob_start(); ?>
<p>Copyright © 2012. All Rights Reserved. solaradeals.com</p>

<p>Designed and Developed by <a href="http://www.haatopia.com">www.haatopia.com</a></p>
